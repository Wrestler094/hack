  ...
  >
    ...
    <div class="blog-detail-wrapper">
      <b-row>
        ...
        <b-col id="blogComment" cols="12" class="mt-2">
          <h6 class="section-label">Коммнтарии</h6>
        ...
        <b-col cols="12" class="mt-2">
          <h6 class="section-label">Отправить комментарий</h6>
          <b-card>
            <b-form>
              <b-row>
                <b-col sm="6">
                  <b-form-group class="mb-2">
                    <b-form-input name="name" placeholder="Имя" />
                  </b-form-group>
                </b-col>
                <b-col sm="6">
                  <b-form-group class="mb-2">
                ...
                <b-col sm="6">
                  <b-form-group class="mb-2">
                    <b-form-input name="website" placeholder="Сайт" />
                  </b-form-group>
                </b-col>
                <b-col cols="12">
                  <b-form-group class="mb-2">
    ...
    <div slot="sidebar" class="blog-sidebar py-2 py-lg-0">
      ...
      <div class="blog-recent-posts mt-3">
        <h6 class="section-label mb-75">Похожие курсы</h6>
        <b-media
      ...
      <div class="blog-categories mt-3">
        <h6 class="section-label mb-1">Категории</h6>
