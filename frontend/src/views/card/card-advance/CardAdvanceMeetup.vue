      ...
      <div class="meetup-header d-flex align-items-center">
        ...
        <div class="my-auto">
          <b-card-title class="mb-25">
            Observability Meetup
          </b-card-title>
          <b-card-text class="mb-0">
            Последние тренды Observability
          </b-card-text>
        </div>
      </div>
      <!--/ metting header -->
...
export default {
  ...
  data() {
    return {
      mediaData: [
        { avatar: 'CalendarIcon', title: '26 декабря 2022', subtitle: '18.00 - 21.00 по Мск' },
        { avatar: 'MapPinIcon', title: 'Офис ICL', subtitle: 'Казань, Россия' },
      ],
      avatars: [
